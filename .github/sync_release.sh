...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-IremM90_MiSTer.git"
CORE_NAME=(Arcade-IremM90)
...
UPSTREAM_CORE_NAME=(Arcade-IremM90)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-IremM90.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-IremM90.rbf)
